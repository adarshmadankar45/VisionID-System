...
SECRET_KEY = 'django-insecure-a2@g#&5=syew7r$k@@#!a@$n181(nuri4j9p6nt7)@&c0#jp*z'
...
# Create a temp directory in your media folder
TEMP_IMAGE_DIR = os.path.join(MEDIA_ROOT, 'temp')
